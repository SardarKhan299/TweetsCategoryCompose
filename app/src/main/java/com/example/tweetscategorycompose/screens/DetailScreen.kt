...
import com.example.tweetscategorycompose.viewmodels.DetailViewModel
...
fun TweetListItem(tweet:String) {
    Card(modifier = Modifier
        ...
        content = {
            Text(text = tweet, modifier = Modifier.padding(16.dp), style = MaterialTheme.typography.headlineMedium)
        }
